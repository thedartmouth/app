...
import {
  StyleSheet, View, FlatList, Text, RefreshControl
} from 'react-native';
        ...
        {this.props.articles.loadingResults ? (
          ...
          <FlatList
            ...
            onEndReached={() => {
              ...
              if (!this.props.articles.loadingResults && !this.state.onEndReachedCalledDuringMomentum) {
            ...
            ListHeaderComponent={this.props.articles.loadingResults ?
              null
              :
              <View>
              <Stack size={0 + 72} />
