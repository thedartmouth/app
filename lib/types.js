...
const articleConverter = (cmsArticle) => {
	...
	const date = originalDate ? new Date(parseInt(originalDate.substring(0, 4)), parseInt(originalDate.substring(5, 7)), parseInt(originalDate.substring(8, 10)), parseInt(originalDate.substring(11, 13)), parseInt(originalDate.substring(14, 16))) : null
	return {
